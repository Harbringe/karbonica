      ...
      const response: ProjectResponse = {
        ...
        data: {
          project: {
            ...
            estimatedCompletionDate: project.estimatedCompletionDate?.toISOString().split('T')[0],
      ...
      const response: ProjectResponse = {
        ...
        data: {
          project: {
            ...
            estimatedCompletionDate: updatedProject.estimatedCompletionDate?.toISOString().split('T')[0],
