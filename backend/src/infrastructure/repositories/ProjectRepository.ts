...
export class ProjectRepository implements IProjectRepository {
  ...
  async findById(id: string): Promise<Project | null> {
    const query = `
      SELECT 
        ...
        image_url as "imageUrl", estimated_completion_date as "estimatedCompletionDate",
  ...
  async save(project: Project): Promise<Project> {
    const query = `
      INSERT INTO projects (
        ...
        status, created_at, updated_at, image_url, estimated_completion_date, contact_info
      )
      VALUES ($1, $2, $3, $4, $5, $6, $7, ST_SetSRID(ST_MakePoint($8, $9), 4326), $10, $11, $12, $13, $14, $15, $16, $17)
      RETURNING 
        id, developer_id as "developerId", title, type, description,
        location, country,
        ST_Y(coordinates::geometry) as latitude,
    ...
    const values = [
      ...
      project.contactInfo ? JSON.stringify(project.contactInfo) : null,
    ];
  ...
  private mapRowToProject(row: any): Project {
    return {
      ...
      estimatedCompletionDate: row.estimatedCompletionDate ? new Date(row.estimatedCompletionDate) : null,
