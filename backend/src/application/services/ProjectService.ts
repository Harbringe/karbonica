  ...
  async createProject(data: CreateProjectData): Promise<Project> {
    try {
      ...
      const verificationRequest: VerificationRequest = {
        ...
        useMultivalidator: false,
        votingDeadline: null,
        autoAssignValidators: false,
      ...
      // NOTE: NFT minting is handled by the frontend calling the web3 microservice directly
      // The project is created in "pending" status and will be updated when the NFT is minted
      // Frontend should call: POST /api/web3/nft/mint with projectId after project creation
